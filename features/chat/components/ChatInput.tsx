...
export function ChatInput({ inputValue, setInputValue, isLoading, onSubmit, onAbort }: Props) {
    ...
    <CardFooter className="p-4 border-t bg-background/50">
      <form onSubmit={onSubmit} className="flex w-full gap-2 items-end">
        ...
        {isLoading ? (
          ...
          <Button type="submit" disabled={!inputValue.trim()} size="icon" className="shrink-0">
